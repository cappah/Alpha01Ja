...
{
	public static final float SIZE = 800 * 2;
	...
	private TerrainTexturePack mTexturePack;
	private TerrainTexture mBlendMap;
	
	private float[][] heights;
	
	public Terrain(int gridX, int gridZ, Loader loader, TerrainTexturePack ttp, TerrainTexture blendMap, String heightMapFile)
	{
		x = gridX * SIZE;
		z = gridZ * SIZE;
		mTexturePack = ttp;
